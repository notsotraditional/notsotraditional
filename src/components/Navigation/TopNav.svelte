...
<header class="flex flex-wrap lg:justify-start lg:flex-nowrap w-full text-lg py-8 dark:bg-neutral-800">
    <nav class="max-w-[85rem] w-full mx-auto px-4 flex flex-wrap basis-full items-center justify-between" aria-label="Global">
      ...
      <div id="navbar-alignment" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow lg:grow-0 lg:basis-auto lg:block lg:order-2">
        <div class="flex flex-col gap-8 mt-5 lg:flex-row lg:items-center lg:mt-0 lg:ps-5 text-base">
